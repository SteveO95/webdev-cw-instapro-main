...
const personalKey = "Sergey-Syomin";
...
export function postUpload({ description, imageUrl, token }) {
  return fetch('https://wedev-api.sky.pro/api/v1/Sergey-Syomin/instapro/', {
    method: "POST",
    headers: {
      Authorization: token,
    },
...
export function getUserPosts({ id }) {
  return fetch(`https://wedev-api.sky.pro/api/v1/Sergey-Syomin/instapro/user-posts/${id}`, {
    method: "GET",
    headers: {
...
export function likeApi({ id, isLiked }) {
  ...
  return fetch('https://wedev-api.sky.pro/api/v1/Sergey-Syomin/instapro/' + `${id}/${lik}`, {
    method: "POST",
    headers: {
      Authorization: getToken(),
    },
